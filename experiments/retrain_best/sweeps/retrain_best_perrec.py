...
Companion to experiments/eeg_jepa/sweeps/retrain_best.py, which retrains the same 7
...
PYTHONPATH=~/Documents/Research/scalable-infra-for-EEG-research/neurolab \\
    python experiments/eeg_jepa/sweeps/retrain_best_perrec.py            # dry run
PYTHONPATH=~/Documents/Research/scalable-infra-for-EEG-research/neurolab \\
    python experiments/eeg_jepa/sweeps/retrain_best_perrec.py --submit
"""
