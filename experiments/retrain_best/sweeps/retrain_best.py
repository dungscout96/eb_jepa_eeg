...
config in experiments/eeg_jepa/sbatch/train.sbatch). This produces best.pth.tar files
...
PYTHONPATH=~/Documents/Research/scalable-infra-for-EEG-research/neurolab \\
    python experiments/eeg_jepa/sweeps/retrain_best.py            # dry run
PYTHONPATH=~/Documents/Research/scalable-infra-for-EEG-research/neurolab \\
    python experiments/eeg_jepa/sweeps/retrain_best.py --submit
"""
...
RUNS = [
    # SIGReg — override is --loss.sigreg.coeff (nested) and --loss.anti_collapse=sigreg
    (1, 1, 64,
     " --loss.anti_collapse=sigreg --loss.sigreg.coeff=1.0",
     "sigreg1.0_nw1_ws1",    "01:30:00"),
    (2, 1, 64,
     " --loss.anti_collapse=sigreg --loss.sigreg.coeff=0.1",
    ...
    (2, 1, 64,
     " --loss.anti_collapse=vicreg --loss.vicreg.std_coeff=1.0 --loss.vicreg.cov_coeff=1.0",
     "vc1.0_proj_nw2_ws1",   "02:00:00"),
    (4, 4, 32,
     " --loss.anti_collapse=vicreg --loss.vicreg.std_coeff=1.0 --loss.vicreg.cov_coeff=1.0",
     "vc1.0_proj_nw4_ws4",   "10:00:00"),
    (4, 4, 32,
     " --loss.anti_collapse=vicreg --loss.vicreg.std_coeff=0.1 --loss.vicreg.cov_coeff=0.1",
     "vc0.1_proj_nw4_ws4",   "10:00:00"),
    # VICReg without projector
    (4, 4, 32,
     " --loss.anti_collapse=vicreg --loss.vicreg.std_coeff=0.1 --loss.vicreg.cov_coeff=0.1 --loss.vicreg.use_projector=false",
