...
Usage:
    python experiments/benchmark/train.py                         # default: binary classification
    python experiments/benchmark/train.py benchmark.task_mode=regression
    python experiments/benchmark/train.py benchmark.task_mode=tertile
"""
