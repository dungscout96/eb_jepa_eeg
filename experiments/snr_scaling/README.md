...
| [`RESULTS_epoch_curve.md`](RESULTS_epoch_curve.md) | three arms (`e04` warm/d22, `e05rand` scratch/d22, `e03` scratch/d12) re-selected on a held-out probe instead of the validation AUC — 1260 checkpoints. **Verdict: whether the epoch matters depends on the initialisation.** From scratch the optimum tracks cohort size (epoch ~25 at S=10 → 375 at S=1400) and a fixed 325 costs 0.011–0.014 r at S≤200; warm-started it barely moves and costs ~0.004. Also kills the "4400-step budget is binding at high S" reading on e04, and quantifies how much of the initialisation gap at small S is epoch protocol rather than initialisation. |
