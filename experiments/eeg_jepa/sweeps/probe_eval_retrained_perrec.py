...
Pairs with experiments/eeg_jepa/sweeps/retrain_best_perrec.py. Each checkpoint is
...
PYTHONPATH=~/Documents/Research/scalable-infra-for-EEG-research/neurolab \\
    python experiments/eeg_jepa/sweeps/probe_eval_retrained_perrec.py            # dry run
PYTHONPATH=~/Documents/Research/scalable-infra-for-EEG-research/neurolab \\
    python experiments/eeg_jepa/sweeps/probe_eval_retrained_perrec.py --submit
"""
