...
Pairs with experiments/eeg_jepa/sweeps/retrain_best.py. Same 7 configs as the
...
PYTHONPATH=~/Documents/Research/scalable-infra-for-EEG-research/neurolab \\
    python experiments/eeg_jepa/sweeps/probe_eval_retrained_global.py            # dry run
PYTHONPATH=~/Documents/Research/scalable-infra-for-EEG-research/neurolab \\
    python experiments/eeg_jepa/sweeps/probe_eval_retrained_global.py --submit
"""
